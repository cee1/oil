 ...
 * 
 * In the stage of initializing testing data, checker->generate_sample will be called 
 * with testing sample.
 * 
 * For each tested function, will run checker->check_result.
 */
/**
 * oil_checker_default:
 *
 ...
 * @checker: an #OilChecker
 * @src: an array of #OilGenericType, represents each argument of the tested function.
 * 
 * Generate testing sample.
 * <note>
 * <para>
 * oil_checker_sample_generator should only care about pointer arguments in an argument array.
 * </para>
 * </note>
 */
 ...
 * </note>
 *
 * Returns: TRUE for acceptable precision, FALSE for not acceptable
 */
